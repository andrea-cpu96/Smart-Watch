...
C_SRCS += \
../Example/User/CM7/AVI_parser.c \
../Example/User/CM7/GC9A01.c \
../Example/User/CM7/decode_dma.c \
../Example/User/CM7/main.c \
../Example/User/CM7/sd_diskio.c \
../Example/User/CM7/smart_watch.c \
../Example/User/CM7/stm32h7xx_hal_msp.c \
../Example/User/CM7/stm32h7xx_it.c \
../Example/User/CM7/syscalls.c \
../Example/User/CM7/sysmem.c 

OBJS += \
./Example/User/CM7/AVI_parser.o \
./Example/User/CM7/GC9A01.o \
./Example/User/CM7/decode_dma.o \
./Example/User/CM7/main.o \
./Example/User/CM7/sd_diskio.o \
./Example/User/CM7/smart_watch.o \
...
clean-Example-2f-User-2f-CM7:
	-$(RM) ./Example/User/CM7/AVI_parser.cyclo ./Example/User/CM7/AVI_parser.d ./Example/User/CM7/AVI_parser.o ./Example/User/CM7/AVI_parser.su ./Example/User/CM7/GC9A01.cyclo ./Example/User/CM7/GC9A01.d ./Example/User/CM7/GC9A01.o ./Example/User/CM7/GC9A01.su ./Example/User/CM7/decode_dma.cyclo ./Example/User/CM7/decode_dma.d ./Example/User/CM7/decode_dma.o ./Example/User/CM7/decode_dma.su ./Example/User/CM7/main.cyclo ./Example/User/CM7/main.d ./Example/User/CM7/main.o ./Example/User/CM7/main.su ./Example/User/CM7/sd_diskio.cyclo ./Example/User/CM7/sd_diskio.d ./Example/User/CM7/sd_diskio.o ./Example/User/CM7/sd_diskio.su ./Example/User/CM7/smart_watch.cyclo ./Example/User/CM7/smart_watch.d ./Example/User/CM7/smart_watch.o ./Example/User/CM7/smart_watch.su ./Example/User/CM7/stm32h7xx_hal_msp.cyclo ./Example/User/CM7/stm32h7xx_hal_msp.d ./Example/User/CM7/stm32h7xx_hal_msp.o ./Example/User/CM7/stm32h7xx_hal_msp.su ./Example/User/CM7/stm32h7xx_it.cyclo ./Example/User/CM7/stm32h7xx_it.d ./Example/User/CM7/stm32h7xx_it.o ./Example/User/CM7/stm32h7xx_it.su ./Example/User/CM7/syscalls.cyclo ./Example/User/CM7/syscalls.d ./Example/User/CM7/syscalls.o ./Example/User/CM7/syscalls.su ./Example/User/CM7/sysmem.cyclo ./Example/User/CM7/sysmem.d ./Example/User/CM7/sysmem.o ./Example/User/CM7/sysmem.su

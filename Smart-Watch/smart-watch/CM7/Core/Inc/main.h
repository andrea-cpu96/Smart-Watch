...
/* Private defines -----------------------------------------------------------*/
#define GC9A01_SCK_Pin GPIO_PIN_0
#define GC9A01_SCK_GPIO_Port GPIOK
#define GC9A01_CS_Pin GPIO_PIN_1
#define GC9A01_CS_GPIO_Port GPIOK
#define GC9A01_MISO_Pin GPIO_PIN_11
#define GC9A01_MISO_GPIO_Port GPIOJ
#define GC9A01_MOSI_Pin GPIO_PIN_10
#define GC9A01_MOSI_GPIO_Port GPIOJ

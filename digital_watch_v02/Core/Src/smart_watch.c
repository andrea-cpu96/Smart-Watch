...
/** Output data buffer 1 (format RGB565) */
uint8_t output_data1[LCD_SIDE_SIZE * LCD_SIDE_SIZE * 3 + 100];
/** Output data buffer 2 (format RGB565) */
...
/** Pointer to the accelerometer handler */
fxls8974_i2c_sensorhandle_t *pAcc_Handle;

/** Accelerometer interrupt flag */
...
/** @brief Process MJPEG video */
static int mjpeg_video_processing(void);

/** @brief Handle file operations */
...
/**
 * @brief smart_watch_test_display
 *
 * @return int
 */
...
/**
 * @brief smart_watch_test_accelerometer
 * 
 * @param pSensorHandle 
 * @return int 
 */
